...
export async function listPhoneNumbers(props: {
  ...
  try {
    ...
    throw new WhatsappException("Unable to list WhatsApp's phone numbers").setOriginError(error)
  }
}
...
export async function findPhoneNumber(props: {
  ...
  try {
    ...
    throw new WhatsappException("Unable to find WhatsApp's phone number").setOriginError(error)
  }
}
...
export const findConversationalAutomation = async (
  ...
  try {
    ...
    throw new WhatsappException("Failed to list conversational automation").setOriginError(e)
  }
}
...
export async function updateConversationalAutomation(
  ...
  try {
    ...
    throw new WhatsappException("Failed to update conversational automation").setOriginError(e)
  }
}
