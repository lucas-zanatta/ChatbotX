...
export const webhookModel = pgTable(
  "Webhook",
  {
    ...
    url: text().notNull(),
    method: text().default("POST").notNull(),
...
export const conditionModel = pgTable(
  "Condition",
  {
    ...
    operator: text(),
    value: text(),
    conditionGroup: integer().default(0).notNull(),
  },
  (table) => [
    ...
    index("Condition_eventType_eventSourceId_idx").using(
      "btree",
      table.eventType.asc().nullsLast(),
      table.eventSourceId.asc().nullsLast(),
    ),
  ],
)
...
export const triggerStatsModel = pgTable(
  "TriggerStats",
  {
    ...
    totalExecutions: integer().default(0).notNull(),
    successfulExecutions: integer().default(0).notNull(),
    failedExecutions: integer().default(0).notNull(),
  },
  (table) => [
    uniqueIndex("TriggerStats_triggerId_key").using(
      "btree",
      table.triggerId.asc().nullsLast(),
    ),
  ],
...
export const triggerContactHistoryModel = pgTable(
  ...
  (table) => [
    index("TriggerContactHistory_triggerId_idx").using(
      "btree",
      table.triggerId.asc().nullsLast(),
    ),
...
export const triggerExecutionModel = pgTable(
  ...
  (table) => [
    index("TriggerExecution_triggerId_idx").using(
      "btree",
      table.triggerId.asc().nullsLast(),
    ),
