...
ALTER TABLE "FlowAnalyticsSession" ADD CONSTRAINT "FlowAnalyticsSession_flowId_fkey" FOREIGN KEY ("flowId") REFERENCES "Flow"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
ALTER TABLE "FlowAnalyticsSession" ADD CONSTRAINT "FlowAnalyticsSession_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
